    ...
    *,
    ...
    return {
        ...
        "authority": (
            ...
            "Do not emit menu_evidence_id. For a real menu choice, cite the menu record in the "
    ...
    *,
    ...
    return {
        ...
        "authority": (
            ...
            "IDs must name declared scenes, not continuations. Do not emit menu_evidence_id. Cite "
