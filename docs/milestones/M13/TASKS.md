...
| Integration and verification | Primary | Integrated diff, Windows suites, browser/package/private acceptance | Implementation complete | Complete | Runtime freeze `e0fd3bf`; focused 70 passed; Release 966/7; private 1,812-scene and Chrome 100%/200% acceptance passed |
