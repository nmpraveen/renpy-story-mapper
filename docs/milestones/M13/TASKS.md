...
| Public-synthetic schema canary | Primary | One public-synthetic schema-v3/provider-v2 call only after exact approval | Local gates complete | Pending | Zero-call preview `tmp/m13-schema-canary-preview-edf80ed.json`, SHA-256 `64317773...22a678`; execution not authorized or attempted |
...
| PR readiness | Primary | Evidence audit, reports, infographic, PR preparation | Verification and review passed | Blocked | Canary approval, successful live/replay evidence, and independent final-head PASS remain absent; PR must not be created without approval |
