...
| `019f5c09-ba0e-70b1-9c6c-47bfbeb83590` | Fix bounded projection validation | Correct AI Story Map projection for mixed validated/fallback bounded-window assemblies while retaining untouched nodes as technical fallback | `codex/m08-bounded-projection-fix` | Active; opened after live bounded validation exposed fail-closed rejection of valid window IDs |
