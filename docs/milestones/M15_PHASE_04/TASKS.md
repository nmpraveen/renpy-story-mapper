...
| Lean integration review | One separate visible reviewer | Review the integrated vertical path against the eight lean criteria | Both workers integrated | In progress | One exact integrated-head verdict; no per-worker reviewer tree |
...
| Final lean gate and PR readiness | Orchestra | Focused tests, user screenshots, sharded CI, one Release/package gate, evidence, ready PR #30 | User accepts output | In progress | Focused integrated gate: 120 passed. Normal/effective-200 screenshots captured. Final review, Release, one push/CI check, and explicit user usefulness approval remain; leave PR open and unmerged. |
