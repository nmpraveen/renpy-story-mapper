...
| Real MsDenvers check | Orchestra with explicit user consent | Run supported workflow, inspect representative story/branch/path samples, show result to user | Integrated path and zero-submit preview | In progress | Exact preview `9d449b95…a3a2c1`: 425 chunks/jobs, 2,927 maximum cloud calls, 0 local calls, 0 cache hits, zero accounting; awaiting consent |
