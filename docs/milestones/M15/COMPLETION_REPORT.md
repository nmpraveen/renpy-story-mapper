...
| Current whole-scope Stage H | Lock-policy correction review | V5 failed closed after two calls with `semantic_reinterpretation`; no hierarchy/publication exists. Commit `b97fa47` corrects the whole-scope internal-lock mapping without weakening byte-for-byte enforcement and awaits independent exact-head review. |
