...
| Current whole-scope Stage H | Typed repair correction review | V9 failed closed after two calls with `hierarchy_authority_invalid`; no hierarchy/publication exists. Exact manifest `consent_8f0c4d16185f61f8d2e194ee` used 483,853 input and 33,824 output tokens; result SHA-256 is `4F59C6756C62536FEA238654283A76A80F57080D0F6BA962C4F09481E5878272`. Prompt v9/policy v10/product v5 retain valid beats and replace only clusters for typed choice splits. |
