...
lifecycle returned through `Revise`, and the failing-first input-v3/prompt-v6/repair-policy-v7
assembler-context correction has repeated semantic `PASS`. Independent exact-head review is next.
