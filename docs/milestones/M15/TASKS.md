...
Lifecycle: `In progress` after Stage H v7 failed closed with `invalid_beat_group`, returned through
`Revise`, and received failing-first prompt-v5/repair-policy-v6 correction with repeated semantic
`PASS`; independent exact-head rereview passed `6ab84ab` with no P0-P2.
