...
Lifecycle: `In progress` after Stage H v6 failed closed with `uncertain_membership`, returned
through `Revise`, and received ambiguity-threshold correction `b81dbad` with repeated semantic
`PASS`; independent exact-head rereview passed `dc5a631` with no P0-P2.
