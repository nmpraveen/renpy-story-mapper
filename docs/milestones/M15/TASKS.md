...
| Phase 01 calibration preparation | Separate visible task/worktree | Lifecycle reconciliation | Pending | Coherent packets, compact digests, frozen prompts/schemas, manifests, scoring tools; zero provider calls |
