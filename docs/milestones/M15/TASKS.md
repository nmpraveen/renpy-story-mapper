...
| Revised Track C - compact projection and browser product | New visible task plus separate exact-head reviewer | Revised shared freeze | Pending | Compact chronology, meaningful summaries, exact arms/evidence, nested rejoins, role filtering, normal-flow 100%/200% UI |
| Revised integration and provider-free acceptance | Coordinator plus independent architecture reviewer | Reviewed Tracks A/B/C | Pending | Integrate in order; fake-provider, compatibility, reopen and zero-submit replay; freeze exact identities |
